...
import "react-dom";
import { ArrowRight as k, X as S, Menu as _, Check as V } from "lucide-react";
function h(e, r) {
    ...
    if (a)
      return () => {
        for (let l = 0; l < n.length; l++) {
          const i = n[l];
          typeof i == "function" ? i() : h(e[l], null);
        }
      };
  };
}
var M = /* @__PURE__ */ Symbol.for("react.lazy"), p = s[" use ".trim().toString()];
function j(e) {
  return typeof e == "object" && e !== null && "then" in e;
}
function g(e) {
  return e != null && typeof e == "object" && "$$typeof" in e && e.$$typeof === M && "_payload" in e && j(e._payload);
}
// @__NO_SIDE_EFFECTS__
function x(e) {
  const r = /* @__PURE__ */ A(e), a = s.forwardRef((n, l) => {
    let { children: i, ...d } = n;
    g(i) && typeof p == "function" && (i = p(i._payload));
    const c = s.Children.toArray(i), u = c.find(P);
    if (u) {
      const f = u.props.children, y = c.map((m) => m === u ? s.Children.count(f) > 1 ? s.Children.only(null) : s.isValidElement(f) ? f.props.children : null : m);
      return /* @__PURE__ */ t(r, { ...d, ref: l, children: s.isValidElement(f) ? s.cloneElement(f, void 0, y) : null });
    }
    return /* @__PURE__ */ t(r, { ...d, ref: l, children: i });
  });
  return a.displayName = `${e}.Slot`, a;
}
var E = /* @__PURE__ */ x("Slot");
// @__NO_SIDE_EFFECTS__
function A(e) {
  const r = s.forwardRef((a, n) => {
    let { children: l, ...i } = a;
    if (g(l) && typeof p == "function" && (l = p(l._payload)), s.isValidElement(l)) {
      const d = Z(l), c = T(i, l.props);
      return l.type !== s.Fragment && (c.ref = n ? R(n, d) : d), s.cloneElement(l, c);
    }
...
function P(e) {
  return s.isValidElement(e) && typeof e.type == "function" && "__radixId" in e.type && e.type.__radixId === L;
}
function T(e, r) {
  const a = { ...r };
  for (const n in r) {
    const l = e[n], i = r[n];
    /^on[A-Z]/.test(n) ? l && i ? a[n] = (...c) => {
      const u = i(...c);
      return l(...c), u;
    } : l && (a[n] = l) : n === "style" ? a[n] = { ...l, ...i } : n === "className" && (a[n] = [l, i].filter(Boolean).join(" "));
  }
  return { ...e, ...a };
}
function Z(e) {
  let r = Object.getOwnPropertyDescriptor(e.props, "ref")?.get, a = r && "isReactWarning" in r && r.isReactWarning;
  return a ? e.ref : (r = Object.getOwnPropertyDescriptor(e, "ref")?.get, a = r && "isReactWarning" in r && r.isReactWarning, a ? e.props.ref : e.props.ref || e.ref);
}
function B(...e) {
  return H(N(e));
}
...
function C({
  ...
  return /* @__PURE__ */ t(
    ...
    {
      "data-slot": "button",
      className: B($({ variant: r, size: a, className: e })),
      ...l
    }
  );
}
var z = [
  ...
  const a = /* @__PURE__ */ x(`Primitive.${r}`), n = s.forwardRef((l, i) => {
    const { asChild: d, ...c } = l, u = d ? a : r;
    return typeof window < "u" && (window[/* @__PURE__ */ Symbol.for("radix-ui")] = !0), /* @__PURE__ */ t(u, { ...c, ref: i });
  });
  return n.displayName = `Primitive.${r}`, { ...e, [r]: n };
}, {}), O = "AspectRatio", b = s.forwardRef(
  (e, r) => {
    const { ratio: a = 1 / 1, style: n, ...l } = e;
    return /* @__PURE__ */ t(
      "div",
      {
        style: {
...
const I = D, Q = ({
  ...
  "section",
  {
    ...
    children: /* @__PURE__ */ o("div", { className: "container-padding-x container mx-auto flex flex-col items-center gap-12 lg:flex-row lg:gap-16", children: [
      /* @__PURE__ */ o(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ o("div", { className: "section-title-gap-xl flex flex-col", children: [
              /* @__PURE__ */ t("h1", { id: "hero-heading", className: "heading-xl", children: e }),
              /* @__PURE__ */ t("p", { className: "text-muted-foreground text-base lg:text-lg", children: r })
            ] }),
            a && /* @__PURE__ */ t("div", { className: "flex flex-col gap-2 md:gap-3", children: a() }),
            /* @__PURE__ */ o("div", { className: "flex flex-col gap-3 sm:flex-row", children: [
              /* @__PURE__ */ t(C, { asChild: !0, children: /* @__PURE__ */ t("a", { href: l, children: n }) }),
              /* @__PURE__ */ t(C, { variant: "ghost", asChild: !0, children: /* @__PURE__ */ o("a", { href: d, children: [
                i,
                /* @__PURE__ */ t(k, {})
              ] }) })
            ] })
      ...
      /* @__PURE__ */ t("div", { className: "w-full flex-1", children: /* @__PURE__ */ t(I, { ratio: 1 / 1, children: /* @__PURE__ */ t(
        "img",
        {
          src: c?.url || "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Hero-EK6lJQh9Tq3HAhrRx6QQGhjNwND9Gs.png",
          alt: "Hero visual",
...
], W = ({ width: e = 135, height: r = 36, className: a }) => /* @__PURE__ */ o(
  "svg",
  {
    width: e,
    height: r,
    ...
    children: [
      /* @__PURE__ */ o("g", { clipPath: "url(#clip0_22005_7547)", children: [
        /* @__PURE__ */ o("g", { clipPath: "url(#clip1_22005_7547)", children: [
          /* @__PURE__ */ t(
            "path",
            {
              fillRule: "evenodd",
  ...
  const [e, r] = v(!1);
  return /* @__PURE__ */ t("nav", { className: "bg-background sticky top-0 isolate z-50 border-b py-3.5 md:py-4", children: /* @__PURE__ */ o("div", { className: "relative container m-auto flex flex-col justify-between gap-4 px-6 md:flex-row md:items-center md:gap-6", children: [
    /* @__PURE__ */ o("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ t("a", { href: "/", children: /* @__PURE__ */ t(W, {}) }),
      /* @__PURE__ */ t(
        C,
        {
          variant: "ghost",
          ...
          children: e ? /* @__PURE__ */ t(S, {}) : /* @__PURE__ */ t(_, {})
        }
      )
    ] }),
    /* @__PURE__ */ o("div", { className: "hidden w-full flex-row justify-end gap-5 md:flex", children: [
      /* @__PURE__ */ o("div", { className: "flex flex-col gap-1 md:flex-row", children: [
        /* @__PURE__ */ t("a", { href: "#features", children: /* @__PURE__ */ t(C, { variant: "ghost", className: "w-full md:w-auto", children: "Features" }) }),
        /* @__PURE__ */ t("a", { href: "#about", children: /* @__PURE__ */ t(C, { variant: "ghost", className: "w-full md:w-auto", children: "About" }) }),
        /* @__PURE__ */ t("a", { href: "#contact", children: /* @__PURE__ */ t(C, { variant: "ghost", className: "w-full md:w-auto", children: "Contact" }) })
      ] }),
      /* @__PURE__ */ t("a", { href: "#pricing", children: /* @__PURE__ */ t(C, { children: "Try for free" }) })
    ] }),
    e && /* @__PURE__ */ o("div", { className: "flex w-full flex-col justify-end gap-5 pb-2.5 md:hidden", children: [
      /* @__PURE__ */ o("div", { className: "flex flex-col gap-1 md:flex-row", children: [
        /* @__PURE__ */ t("a", { href: "#features", children: /* @__PURE__ */ t(C, { variant: "ghost", className: "w-full md:w-auto", children: "Features" }) }),
        /* @__PURE__ */ t("a", { href: "#about", children: /* @__PURE__ */ t(C, { variant: "ghost", className: "w-full md:w-auto", children: "About" }) }),
        /* @__PURE__ */ t("a", { href: "#contact", children: /* @__PURE__ */ t(C, { variant: "ghost", className: "w-full md:w-auto", children: "Contact" }) })
      ] }),
      /* @__PURE__ */ t("a", { href: "#pricing", children: /* @__PURE__ */ t(C, { className: "w-full", children: "Try for free" }) })
    ] })
  ] }) });
}, Y = [
  ...
  "section",
  {
    ...
    children: /* @__PURE__ */ o("div", { className: "container-padding-x container mx-auto flex flex-col gap-10", children: [
      /* @__PURE__ */ o("div", { className: `flex flex-col gap-3 ${{
        left: "text-left",
        center: "text-center",
        right: "text-right"
      }[l]}`, children: [
        /* @__PURE__ */ t("h2", { id: "team-heading", className: "heading-lg", children: e }),
        r && /* @__PURE__ */ t("p", { className: "text-muted-foreground text-base lg:text-lg", children: r })
      ] }),
      i && /* @__PURE__ */ t(
        "div",
        {
  ...
  feature: e = "Your feature here"
}) => /* @__PURE__ */ o("div", { className: "flex items-start gap-3", children: [
  /* @__PURE__ */ t("div", { className: "pt-0.5", children: /* @__PURE__ */ t(V, { className: "text-primary h-5 w-5" }) }),
  /* @__PURE__ */ t("span", { className: "text-card-foreground text-base leading-6 font-medium", children: e })
] }), X = [
  {
    id: "feature",
    label: "Feature",
...
], e1 = ({ teamMember: e }) => !e || typeof e == "string" ? /* @__PURE__ */ o("div", { className: "flex flex-col items-center gap-3 rounded-xl border border-border bg-card p-6 text-center shadow-sm", children: [
...
] }) : /* @__PURE__ */ o("div", { className: "flex flex-col items-center gap-3 rounded-xl border border-border bg-card p-6 text-center shadow-sm", children: [
  e.profile_picture?.url && /* @__PURE__ */ t(
    "img",
    {
      src: e.profile_picture.url,
      alt: e.name,
      className: "h-20 w-20 rounded-full object-cover"
    }
  ),
  /* @__PURE__ */ o("div", { className: "flex flex-col gap-1", children: [
    /* @__PURE__ */ o("p", { className: "text-card-foreground font-semibold", children: [
      e.name,
      " ",
      e.last_name
    ] }),
    e.role && /* @__PURE__ */ t("p", { className: "text-muted-foreground text-sm", children: e.role })
  ] })
] }), t1 = [
  {
    id: "teamMember",
...
export {
  u1 as blockSettingsSchemas,
  C1 as blocksComponents,
  f1 as sectionBlocksConfig,
  d1 as sectionSettingsSchemas,
  c1 as sectionsComponents
};
